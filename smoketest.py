...
#    '/cchdo?startDate=2010-01-01T00:00:00Z&endDate=2010-02-01T00:00:00Z&data=all&verticalRange=0,100.12345', # recall we started excluding the lower vertical bound,$
#    '/cchdo?startDate=2010-01-01T00:00:00Z&endDate=2010-02-01T00:00:00Z&data=temperature,pressure',
#    '/cchdo?startDate=2010-01-01T00:00:00Z&endDate=2010-02-01T00:00:00Z&data=temperature,1,pressure',
#    '/cchdo?woceline=A10',
...
routes_to_check = [
   ...
   '/grids/rg09?polygon=[[0,0],[0,5],[5,5],[5,0],[0,0]]&startDate=2010-01-01T00:00:00Z&endDate=2011-01-01T00:00:00Z&data=all&verticalRange=0,100.12345', # recall we started excluding the lower vertical bound, so for these purposes let's check bounds that probably dont exactly appear in the dataset.
